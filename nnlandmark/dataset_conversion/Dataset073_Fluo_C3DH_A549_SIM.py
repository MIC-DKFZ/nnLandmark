...
if __name__ == '__main__':
    ...
    imagestr = join(nnLM_raw, dataset_name, 'imagesTr')
    imagests = join(nnLM_raw, dataset_name, 'imagesTs')
    labelstr = join(nnLM_raw, dataset_name, 'labelsTr')
    ...
    save_json(splits, join(nnLM_preprocessed, dataset_name, 'splits_final.json'))