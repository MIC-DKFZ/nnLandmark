...
from nnlandmark.dataset_conversion.Dataset027_ACDC import make_out_dirs
...
def create_custom_splits(src_data_folder: Path, csv_file: str, dataset_id: int, num_val_patients: int = 25):
    existing_splits = os.path.join(nnLM_preprocessed, f"Dataset{dataset_id}_MNMs", "splits_final.json")
