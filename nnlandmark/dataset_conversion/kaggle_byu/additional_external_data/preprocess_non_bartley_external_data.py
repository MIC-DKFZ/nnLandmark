...
from nnlandmark.dataset_conversion.kaggle_byu.bartley_additional_data import process_image
...
if __name__ == '__main__':
    ...
    ref_dataset = load_json(join(nnLM_raw, maybe_convert_to_dataset_name(186), 'dataset.json'))
