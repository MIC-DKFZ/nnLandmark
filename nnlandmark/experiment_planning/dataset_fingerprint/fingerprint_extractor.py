...
class DatasetFingerprintExtractor(object):
    def __init__(self, dataset_name_or_id: Union[str, int], num_processes: int = 8, verbose: bool = False):
        ...
        self.input_folder = join(nnLM_raw, dataset_name)
    ...
    def run(self, overwrite_existing: bool = False) -> dict:
        ...
        # reliably write in nnLM_preprocessed and nnLM_results, so nnLM_preprocessed it is
        preprocessed_output_folder = join(nnLM_preprocessed, self.dataset_name)
