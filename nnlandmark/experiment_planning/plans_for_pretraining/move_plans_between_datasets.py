...
from nnlandmark.utilities.file_path_utilities import maybe_convert_to_dataset_name
...
def move_plans_between_datasets(
    ...
    source_folder = join(nnLM_preprocessed, source_dataset_name)
    ...
    target_raw_data_dir = join(nnLM_raw, target_dataset_name)
    ...
    save_json(source_plans, join(nnLM_preprocessed, target_dataset_name, target_plans_identifier + '.json'),
              sort_keys=False)
