...
from nnlandmark.ensembling.ensemble import ensemble_folders
from nnlandmark.evaluation.find_best_configuration import find_best_configuration, \
    dumb_trainer_config_plans_to_trained_models_dict
from nnlandmark.inference.predict_from_raw_data import nnUNetPredictor
from nnlandmark.paths import nnLM_raw, nnLM_results
from nnlandmark.postprocessing.remove_connected_components import apply_postprocessing_to_folder
...
if __name__ == '__main__':
    ...
    source_dir = join(nnLM_raw, dataset_name, 'imagesTs')
    target_dir_base = join(nnLM_results, dataset_name)
