...
from nnlandmark.configuration import ANISO_THRESHOLD, default_num_processes
from nnlandmark.evaluation.evaluate_predictions import compute_metrics_on_folder
from nnlandmark.inference.export_prediction import export_prediction_from_logits, resample_and_save
...
from nnlandmark.paths import nnLM_preprocessed, nnLM_results
...
from nnlandmark.training.loss.compound_losses import DC_and_CE_loss, DC_and_BCE_loss
from nnlandmark.training.loss.deep_supervision import DeepSupervisionWrapper
from nnlandmark.training.loss.dice import get_tp_fp_fn_tn, MemoryEfficientSoftDiceLoss
...
from nnlandmark.utilities.label_handling.label_handling import convert_labelmap_to_one_hot, determine_num_input_channels
...
class nnUNetTrainer(object):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict,
        ...
        self.preprocessed_dataset_folder_base = join(nnLM_preprocessed, self.plans_manager.dataset_name) \
            if nnLM_preprocessed is not None else None
        self.output_folder_base = join(nnLM_results, self.plans_manager.dataset_name,
                                       self.__class__.__name__ + '__' + self.plans_manager.plans_name + "__" + configuration) \
            if nnLM_results is not None else None
        ...
        self.folder_with_segs_from_previous_stage = \
            join(nnLM_results, self.plans_manager.dataset_name,
            ...
            for i, k in enumerate(dataset_val.identifiers):
                ...
                if next_stages is not None:
                    for n in next_stages:
                        ...
                        expected_preprocessed_folder = join(nnLM_preprocessed, self.plans_manager.dataset_name,
