...
from nnlandmark.training.dataloading.nnunet_dataset import infer_dataset_class, nnUNetBaseDataset
from nnlandmark.utilities.dataset_name_id_conversion import maybe_convert_to_dataset_name
from nnlandmark.utilities.plans_handling.plans_handler import ConfigurationManager
from nnlandmark.utilities.utils import get_identifiers_from_splitted_dataset_folder, \
...
def generate_overlays_from_raw(dataset_name_or_id: Union[int, str], output_folder: str,
    ...
    folder = join(nnLM_raw, dataset_name)
...
def generate_overlays_from_preprocessed(dataset_name_or_id: Union[int, str], output_folder: str,
                                        ...
                                        overlay_intensity: float = 0.6):
    dataset_name = maybe_convert_to_dataset_name(dataset_name_or_id)
    folder = join(nnLM_preprocessed, dataset_name)
