...
from nnlandmark.imageio.reader_writer_registry import recursive_find_reader_writer_by_name
from nnlandmark.utilities.find_class_by_name import recursive_find_python_class
from nnlandmark.utilities.label_handling.label_handling import get_labelmanager_class_from_plans
...
class ConfigurationManager(object):
    ...
    def preprocessor_class(self) -> Type[DefaultPreprocessor]:
        preprocessor_class = recursive_find_python_class(join(nnlandmark.__path__[0], "preprocessing"),
                                                         self.preprocessor_name,
                                                         current_module="nnlandmark.preprocessing")
...
if __name__ == '__main__':
    ...
    plans = load_json(join(nnLM_preprocessed, maybe_convert_to_dataset_name(3), 'nnUNetPlans.json'))
