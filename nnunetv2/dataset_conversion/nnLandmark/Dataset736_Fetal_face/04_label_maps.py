...
def main():
    ...
    p.add_argument("--base",   default="/home/a332l/dev/Project_nnLandmark/data/landmark_datasets/face_dataset/volume/", 
                   help="Pose volumes folder")
    p.add_argument("--landmarks", default="/home/a332l/dev/Project_nnLandmark/nnunet_data/nnUNet_raw/Dataset736_Fetal_face/all_landmarks_voxel.json", 
                   help="JSON of landmarks")
    p.add_argument("--name2label", default="/home/a332l/dev/Project_nnLandmark/nnunet_data/nnUNet_raw/Dataset736_Fetal_face/name_to_label.json",
                   help="JSON: landmark_<n> → int label  (default: derive on the fly)")
    p.add_argument("--output",    default="/home/a332l/dev/Project_nnLandmark/nnunet_data/nnUNet_raw/Dataset736_Fetal_face/labelsAll/", 
