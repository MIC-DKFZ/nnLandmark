...
def main() -> None:
    ...
    ap.add_argument("--images", default="/home/a332l/dev/Project_SoftDiceLoss/nnunet_data/nnUNet_raw/Dataset732_Fetal_pose/imagesAll/", help="imagesAll directory")
    ap.add_argument("--labels", default="/home/a332l/dev/Project_SoftDiceLoss/nnunet_data/nnUNet_raw/Dataset732_Fetal_pose/labelsAll/", help="labelsAll directory")
    ap.add_argument("--outdir", default="/home/a332l/dev/Project_SoftDiceLoss/nnunet_data/nnUNet_raw/Dataset732_Fetal_pose/", help="folder where new dirs are created")
    ap.add_argument("--n_test", type=int, default=100, help="number of test cases")
