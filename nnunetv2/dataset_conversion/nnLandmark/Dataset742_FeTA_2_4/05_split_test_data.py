...
def main():
    ...
    ap.add_argument("--root",
        default="/path/to/2024_Ertl_nnLandmark/nnunet_data/nnUNet_raw/Dataset742_FeTA_2_4",
        help="PDDCA dataset root (contains imagesTr/ and labelsTr/)")
    ap.add_argument("--n_test", type=int, default=15, help="Number of random test cases to select")
