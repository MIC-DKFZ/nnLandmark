...
using the affine from the nnUNet_raw imagesTs image, and comparing to original AFIDs FCSV.
...
def main():
    ...
    ap.add_argument("--imagesTs_root", default='/home/a332l/dev/Project_nnLandmark/nnunet_data/nnUNet_raw/Dataset732_Afids/imagesTs/',
                    help="nnUNet_raw Dataset.../imagesTs directory with the original NIfTI files.")
